...
using AutoMapper;
using DevilBlog.Adapter;
using DevilBlog.Adapter.Interfaces;
using DevilBlog.Business;
...
namespace DevilBlog.WebAPI.Extensions
{
    public static class ServiceCollectionExtensions
    {
        ...
        public static IServiceCollection AddPreRenderDebugging(this IServiceCollection services,
        ...
        public static IServiceCollection AddCustomDbContext(this IServiceCollection services)
        {
            ...
            services.AddDbContextPool<DevilBlogDbContext>(options =>
            {
        ...
        public static IServiceCollection AddCustomIdentity(this IServiceCollection services)
        {
            ...
            services.AddIdentity<AspNetUser, AspNetRole>
                ...
                .AddEntityFrameworkStores<DevilBlogDbContext>()
        ...
        public static IServiceCollection AddCustomOpenIddict(this IServiceCollection services, IHostingEnvironment env)
        {
            ...
            services.AddOpenIddict(options =>
            {
                ...
                options.AddEntityFrameworkCoreStores<DevilBlogDbContext>();
        ...
        public static IServiceCollection RegisterCustomServices(this IServiceCollection services)
        {
            ...
            services.AddScoped<AspNetUserManager>();
            services.AddScoped<AspNetRoleManager>();
